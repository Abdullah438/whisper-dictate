...
2. Do not dictate passwords, recovery phrases, or secrets. Clipboard history keeps them after the run; set `DICTATE_CLIPBOARD=0` if that matters more to you than the clipboard fallback.
